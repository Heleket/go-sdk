# Heleket Go integration — documentation

This documentation set covers everything you need to integrate Heleket from a Go application. It is written for merchants and developers; no prior knowledge of the Heleket API is assumed.
...
| [02 — Configuration](02-configuration.md) | Once, plus when tuning timeouts/debug/transport |
...
| [11 — Troubleshooting](11-troubleshooting.md) | When stuck |

## Conventions used in the docs

- Code blocks marked `go` are runnable — they assume the import `heleket "github.com/heleket/go-sdk"` and a constructed client.
